...
import com.Interact.Questions.util.JsfUtil;
import com.Interact.Questions.util.JsfUtil.PersistAction;
...
public class UserAnswersController implements Serializable {
    ...
    @EJB
    private com.Interact.Questions.UserAnswersFacade ejbFacade;
    private List<UserAnswers> items = null;
    private UserAnswers selected;

    public UserAnswersController() {
    }

    public UserAnswers getSelected() {
        return selected;
    }

    public void setSelected(UserAnswers selected) {
    ...
    public UserAnswers prepareCreate() {
        selected = new UserAnswers();
    ...
    public List<UserAnswers> getItems() {
        if (items == null) {
    ...
    public UserAnswers getUserAnswers(java.lang.Integer id) {
        return getFacade().find(id);
    }

    public List<UserAnswers> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<UserAnswers> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
